...
X.columns = ['eadible','cap-shape','cap-surface','cap-color','bruises?','odor','gill-attachment','gill-spacing',
...
# .. your code here ..
y = X['eadible']
X.drop(['eadible'],axis=1,inplace=True)
y = y.map({'e':0,'p':1})
#
...
#
# .. your code here ..
tr.export_graphviz(tree.tree_, out_file='tree.dot', feature_names=X.columns)
