...
def drawPredictions(X_train, X_test, y_train, y_test,model):
  fig = plt.figure()
...
kernel='rbf'
svc = SVC(C=1,kernel = kernel,gamma=0.001)
...
#drawPredictions(X_train, X_test, y_train, y_test,svc)
...
#print("1000th test label: ", y_test[999])
...
#
# .. your code here ..
#test999 = pd.DataFrame(X_test.ix[999,:].reshape(1,-1))
#print("1000th test prediction: ",svc.predict(test999))
...
#
# .. your code here ..
#img = pd.DataFrame(X_test.ix[1000,:].reshape(8,8))
#plt.imshow(img)
