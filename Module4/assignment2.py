...
drop_cols = ['id', 'classification']
dum_cols = ['rbc', 'pc', 'pcc', 'ba', 'htn', 'dm', 'cad', 'appet', 'pe', 'ane']
...
# .. your code here ..
cols.dtypes
cols['wc']=pd.to_numeric(cols['wc'])
cols['rc']=pd.to_numeric(cols['rc'])
...
if scaleFeatures: cols = helper.scaleFeatures(cols)
