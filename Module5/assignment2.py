...
#
# .. your code here ..
user1wk = user1[(user1['DOW']=='Sat') | (user1['DOW']=='Sun')]
...
#
# .. your code here ..
user1wklate = user1wk[(user1wk['CallTime']< '06:00:00')|(user1wk['CallTime']> '22:00:00')]
user1 = user1wklate
#
...
ax = fig.add_subplot(111)
ax.scatter(user1.TowerLon,user1.TowerLat, c='g', marker='o', alpha=0.2)
ax.scatter(cs[:,1],cs[:,0],c='black',alpha=0.5)
ax.set_title('Weekend Calls (<6am or >10p)')
