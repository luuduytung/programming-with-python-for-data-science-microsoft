...
X['nuclei'] = pd.to_numeric(X['nuclei'],errors='coerc')
...
#norma = pp.Normalizer().fit(X_train); X_train = norma.transform(X_train); X_test = norma.transform(X_test)
#norma = pp.MinMaxScaler().fit(X_train); X_train = norma.transform(X_train); X_test = norma.transform(X_test)
#norma = pp.RobustScaler().fit(X_train); X_train = norma.transform(X_train); X_test = norma.transform(X_test)
#norma = pp.StandardScaler().fit(X_train); X_train = norma.transform(X_train); X_test = norma.transform(X_test)
