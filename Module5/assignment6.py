...
X_train,X_test,y_train,y_test = train_test_split(df,face_labels,test_size=0.15,random_state=7)
...
if Test_PCA:
  ...
  X_train=model_iso.transform(X_train)
  X_test=model_iso.transform(X_test)
