...
y = X['wheat_type']
X.drop(['wheat_type','id'],axis=1,inplace=True)
...
#
# NOTE: The reason you only fit against your training dfdata to train with!
...
T_train = model_pca.transform(X_train)
T_test = model_pca.transform(X_test)
