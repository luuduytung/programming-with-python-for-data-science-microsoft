...
#
# .. your code here ..
X_train = pd.DataFrame(X.loc[X['Year']<1986,'Year'])
y_train = pd.DataFrame(X.loc[X['Year']<1986,'WhiteMale'])
...
#
# .. your code here ..
y_trainb = pd.DataFrame(X.loc[X['Year']<1986,'BlackMale'])
modelb = lm.LinearRegression().fit(X_train,y_trainb)
